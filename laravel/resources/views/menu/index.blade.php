...
@section('title', 'La Buena Mesa - Gestión del Menú & Probador API REST')
            ...
            <div class="card-content" style="padding: 20px;">
                ...
                <div class="row mb-0" style="margin-bottom: 15px;">
                    <div class="col s12" style="display: flex; gap: 8px; flex-wrap: wrap; align-items: center;">
                        ...
                        <a href="{{ url('/menu') }}" class="btn-small btn-wine">Todos</a>
                        ...
                        <tbody class="font-montserrat">
                            @forelse($menuItems as $item)
                                <tr id="row-{{ $item->id }}">
                                    ...
                                    <td>
                                        <strong style="color: var(--wine-dark); font-size: 0.95rem; display: block;">{{ $item->name }}</strong>
                                        <small style="color: var(--text-muted); font-size: 0.82rem; display: block; max-width: 260px;">{{ Str::limit($item->description, 60) }}</small>
                                    </td>
                                    <td>
