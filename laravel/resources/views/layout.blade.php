...
<head>
    ...
    <title>@yield('title', 'La Buena Mesa - Alta Gastronomía & Menú Digital')</title>
    ...
    <nav>
        <div class="nav-wrapper container" style="width: 92%; max-width: 1440px;">
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                <li><a href="{{ url('/menu') }}"><i class="material-icons left">menu_book</i> Menú Digital</a></li>
                <li><a href="{{ url('/api/menu-items') }}" target="_blank"><i class="material-icons left">code</i> API REST (JSON)</a></li>
            </ul>
        </div>
    </nav>
    ...
    <footer class="fixed-footer">
        <div class="container">
            ...
            <div class="endpoint-links">
                <a href="{{ url('/api/menu-items') }}" target="_blank">GET /api/menu-items</a>
                <span style="color: var(--accent-gold);">|</span>
                <a href="{{ url('/api/menu-items/category/Plato%20Fuerte') }}" target="_blank">GET /api/menu-items/category/{cat}</a>
            </div>
        </div>
    </footer>
